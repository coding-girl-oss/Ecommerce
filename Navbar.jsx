...
const Navbar = () => {
  ...
  return (
    <>
      <div className="navbar bg-slate-500 justify-between px-2">
       <div className='flex gap-12'>
        <h1 className='text-3xl font-bold text-black'>SHOPYY</h1>
        <p className='text-[15px] py-3 text-black font-bold'><Link to='/'>Home</Link></p>
       </div>
           
        <div className="flex-none">
          <div className="dropdown dropdown-end">
            <div tabIndex={0} role="button" className="btn btn-black btn-circle">
